...
<section id="contact-cta">
    <div class="container">
        <div class="row col-lg-7 text-center text-lg-start reveal">
            <h2>Ready for a Cleaner, Healthier Workplace?</h2>
            <p>
                Get in touch today for a free, no-obligation quote.
                We service all of <?= htmlspecialchars($settings['service_area'] ?? ' Queensland') ?>
            </p>
